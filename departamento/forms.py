...
class DepartamentoForm(forms.ModelForm):
    ...
    singla_departamento = forms.CharField(label='Sigla Departamento', max_length=5, widget=TextInput(attrs={'class': 'form-control', 'autocomplete':'off', 'placeholder':'Ex: TI'}), required=False)
